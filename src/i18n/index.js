...
const messages = {
  ...
  th: {
    ...
    hero: {
      ...
      scrollCta: 'ดูเพิ่มเติม',
    },
    servicesLanding: {
      label: 'บริการ',
      tagline: 'เราพัฒนาระบบ ซอฟต์แวร์ และการเชื่อมต่อที่ช่วยให้ทุกส่วนของธุรกิจทำงานร่วมกันได้อย่างมีประสิทธิภาพ',
      items: [
        { title: 'ระบบ IT ที่ออกแบบเฉพาะองค์กร', desc: 'ออกแบบและพัฒนาระบบให้สอดคล้องกับรูปแบบการทำงานของธุรกิจคุณ ตั้งแต่ระบบบริหารจัดการภายใน ระบบวิเคราะห์ข้อมูล ไปจนถึงโซลูชันเฉพาะทางสำหรับแต่ละอุตสาหกรรม' },
        { title: 'การเชื่อมต่อระบบและบริการ', desc: 'เชื่อมต่อทุกระบบให้ทำงานร่วมกันได้อย่างไร้รอยต่อ ไม่ว่าจะเป็น Payment Gateway ระบบจอง ระบบ E-Commerce หรือบริการจากผู้ให้บริการภายนอก' },
        { title: 'พร้อมรองรับการเติบโต', desc: 'ออกแบบโครงสร้างระบบให้รองรับการขยายตัวของธุรกิจ พร้อมมาตรฐานด้านความปลอดภัย ความน่าเชื่อถือ และความต่อเนื่องในการให้บริการ' },
